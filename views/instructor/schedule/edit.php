...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Edit Class'); ?></title>
    ...
    <div class="container-fluid px-4 py-6 max-w-4xl mx-auto">
        <div class="card shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="card-body bg-white p-4">
                ...
                <?php endif; ?>
                <?php echo form_open('instructor/schedule/edit/' . ($class->class_id ?? 0), ['class' => 'space-y-4']); ?>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" class="form-control mt-1 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500" value="<?php echo htmlspecialchars($class->title ?? ''); ?>" required>
                    </div>
                    <div>
                        <label for="class_date" class="block text-sm font-medium text-gray-700">Class Date</label>
                        <input type="date" name="class_date" id="class_date" class="form-control mt-1 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500" value="<?php echo $class->class_date ?? ''; ?>" min="<?php echo date('Y-m-d'); ?>" required>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label for="start_time" class="block text-sm font-medium text-gray-700">Start Time</label>
                            <input type="time" name="start_time" id="start_time" class="form-control mt-1 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500" value="<?php echo $class->start_time ?? ''; ?>" required>
                        </div>
                        <div>
                            <label for="end_time" class="block text-sm font-medium text-gray-700">End Time</label>
                            <input type="time" name="end_time" id="end_time" class="form-control mt-1 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500" value="<?php echo $class->end_time ?? ''; ?>" required>
                        </div>
                    </div>
                    <div>
                        <label for="status" class="block text-sm font-medium text-gray-700">Status</label>
                        <select name="status" id="status" class="form-select mt-1 block w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500" required>
