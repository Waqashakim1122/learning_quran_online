                ...
                <div class="row">
                    <main class="col-12 px-md-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            ...
                            <a href="<?= site_url('admin/courses') ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-2"></i>Back to Courses</a>
                        </div>
                        ...
                        <form action="<?= site_url('admin/courses/edit/' . $course->course_id) ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="course_name" name="course_name" value="<?= set_value('course_name', $course->course_name) ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="category" name="category" required>
                                                    ...
                                                    <?php foreach ($categories as $category): ?>
                                                        <option value="<?= htmlspecialchars($category) ?>" <?= set_select('category', $category, ($course->category == $category)) ?>><?= htmlspecialchars($category) ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="level" name="level" required>
                                                    ...
                                                    <option value="beginner" <?= set_select('level', 'beginner', ($course->level == 'beginner')) ?>>Beginner</option>
                                                    <option value="intermediate" <?= set_select('level', 'intermediate', ($course->level == 'intermediate')) ?>>Intermediate</option>
                                                    <option value="advanced" <?= set_select('level', 'advanced', ($course->level == 'advanced')) ?>>Advanced</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" id="price" name="price" value="<?= set_value('price', $course->price) ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" id="duration" name="duration" value="<?= set_value('duration', $course->duration) ?>" placeholder="e.g., 8 weeks">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="approval_status" name="approval_status" required>
                                                    <option value="pending" <?= set_select('approval_status', 'pending', ($course->approval_status == 'pending')) ?>>Pending</option>
                                                    <option value="approved" <?= set_select('approval_status', 'approved', ($course->approval_status == 'approved')) ?>>Approved</option>
                                                    <option value="rejected" <?= set_select('approval_status', 'rejected', ($course->approval_status == 'rejected')) ?>>Rejected</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="image-preview-container" class="text-center mb-3 p-4 bg-light rounded">
                                        <?php if (!empty($course->featured_image)): ?>
                                            <img id="current-image" src="<?= base_url('uploads/courses/' . htmlspecialchars($course->featured_image)) ?>" class="img-fluid rounded" style="max-height: 150px;" alt="Current Featured Image">
                                            <img id="new-image-preview" src="#" alt="New Preview" class="img-fluid rounded" style="max-height: 150px; display: none;">
                                        <?php else: ?>
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1" <?= set_checkbox('is_active', '1', ($course->is_active == 1)) ?>>
                                        <label class="form-check-label" for="is_active">Active</label>
                                        <small class="form-text d-block text-muted">Make this course available to students</small>
                                    </div>
                                    <div class="form-check">
                                        <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1" <?= set_checkbox('is_featured', '1', ($course->is_featured == 1)) ?>>
                            ...
                            <div class="d-flex justify-content-between">
                                <a href="<?= site_url('admin/courses') ?>" class="btn btn-secondary"><i class="fas fa-times me-2"></i>Cancel</a>
