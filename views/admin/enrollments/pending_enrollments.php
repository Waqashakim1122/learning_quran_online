...
<head>
    ...
    <title><?php echo htmlspecialchars($title ?? 'Pending Enrollments'); ?> - Admin</title>
                ...
                <div class="row">
                    <main class="col-12 px-md-4">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb bg-transparent p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($title ?? 'Pending Enrollments'); ?></li>
                                </ol>
                            </nav>
                        </div>

                        <h1 class="display-5 fw-bold text-dark mb-4"><?php echo htmlspecialchars($title ?? 'Pending Enrollments'); ?></h1>
                                ...
                                <form method="get" action="<?= base_url('admin/enrollments/pending'); ?>">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <a href="<?= base_url('admin/enrollments/pending'); ?>" class="btn btn-secondary"><i class="fas fa-times me-1"></i> Reset</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header bg-white py-3 border-bottom">
                                <h5 class="mb-0 fw-bold text-dark">Pending Enrollment Requests</h5>
                            </div>
                            <div class="card-body p-0">
                                <?php if (empty($pending_enrollments)): ?>
                                    <div class="alert alert-info text-center m-3">
                                        <i class="fas fa-info-circle me-2"></i> No pending enrollment requests.
                                    </div>
                                <?php else: ?>
                                            ...
                                            <tbody>
                                                <?php foreach ($pending_enrollments as $enrollment): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= htmlspecialchars($enrollment->preferred_instructor_name ?? 'No Preference'); ?></td>
                                                        ...
                                                        <td class="text-center pe-3">
                                                            <div class="btn-group">
                                                                ...
                                                                <?php if (empty($enrollment->assigned_instructor_name)): ?>
